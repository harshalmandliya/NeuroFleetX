...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        navigate('/'); // Will be redirected by RedirectBasedOnRole
      } else {
            ...
            <div>
              <div className="relative rounded-t-md">
                ...
                <input
                  ...
                  className="focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 pr-3 py-3 sm:text-sm border-gray-300 rounded-t-md border"
            ...
            <div>
              <div className="relative rounded-b-md">
                ...
                <input
                  ...
                  className="focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 pr-10 py-3 sm:text-sm border-gray-300 rounded-b-md border"
                  placeholder="••••••••"
                />
                <button
                  type="button"
